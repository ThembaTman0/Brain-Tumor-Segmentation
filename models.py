...
class LogisticRegression:
    ...
    def stochastic_gradient_descent(self,theta,alpha,epsilon,gamma,t_max=100):
        ...
        while t<t_max: 
            i = int(np.random.uniform(0,1)*len(x))
            h=self.sigmoid        
...
#                     return theta,J
    ...
    def genetic_algorithm(self,n,N=50,m=10,t_max=1000):
        ...
        for t in range(t_max):
            ...
            for k in range(0,m,2):
                ...
                x = alpha*(population[L[0],:n])+(1-alpha)*(population[L[1],:n])
                y = (1-beta)*(population[L[0],:n])+beta*(population[L[1],:n])
    ...
    def particle_swarm_optimization(self,n,N,l,u,w,c1,c2,f,t_max):
        ...
        while t<t_max:
            ...
            # maintain feasibility! currently no need to confine search space
